<?php
use App\Http\Controllers\Admin\CustomerRouteController;
/*
  |--------------------------------------------------------------------------
  | Admin Routes
  |--------------------------------------------------------------------------
  ...
  |
 */
Route::get('/sms', 'OrderController@sms')
         ->name('sms');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
     ...
     Route::get('rewardreport', 'RewardController@rewardreport')->name('rewardreport');
    
     Route::get('points', 'CustomerController@points')->name('customers.points');
    Route::get('reward/products', 'RewardController@products')->name('reward.products');
       Route::post('reward/products/store', 'RewardController@store')->name('rewardproduct.store');
    
    Route::get('reward/products/edit/{id}', 'RewardController@edit')->name('reward.edit');
    
    
        Route::get('customer/reward/{id}', 'RewardController@reward')->name('customer.reward');
      Route::post('reward/products/update/{id}', 'RewardController@update')->name('reward.update');
    
    
      Route::post('reward/post/{id}', 'RewardController@post')->name('reward.post');
    ...
    Route::get('/brands/destroy/{id}', 'BrandController@destroy')->name('brands.destroy');
        ...
        Route::post('unit/store', 'UnitsController@store')->name('unit.store');
         Route::get('unit/update/{id}', 'UnitsController@update')->name('unit.update');
        ...
        Route::post('type/store', 'TypesController@store')->name('types.store');
         Route::get('type/update/{id}', 'TypesController@update')->name('types.update');
        Route::get('type/destroy/{id}', 'TypesController@destroy')->name('types.destroy');
        Route::get('type/edit/{id}', 'TypesController@edit')->name('types.edit');



    //handling routesor
    Route::get('routes', 'CustomerRouteController@index')->name('routes.index');
      Route::post('routes/store', 'CustomerRouteController@store')->name('routes.store');
       Route::get('routes/update/{id}', 'CustomerRouteController@update')->name('routes.update');
      Route::get('routes/destroy/{id}', 'CustomerRouteController@destroy')->name('routes.destroy');
      Route::get('routes/edit/{id}', 'CustomerRouteController@edit')->name('routes.edit');
    /*
    Route::get('/brands/edit/{id}', 'BrandController@edit')->name('brands.edit');
    */
    ...
    Route::get('/accounts/dimenstions', 'DimensionsController@index')->name('dimension.index');
    Route::post('/dimension/store', 'DimensionsController@store')->name('dimension.store');
    Route::get('/dimension/destroy/{id}', 'DimensionsController@destroy')->name('dimension.destroy');


  
    //expense types
    Route::get('/expensetypes', 'ExpensetypesController@index')->name('expensetypes.index');
    Route::post('/expensetypes/store', 'ExpensetypesController@store')->name('expensetypes.store');
    Route::get('/expensetypes/destroy/{id}', 'ExpensetypesController@destroy')->name('expensetypes.destroy');


        //expense
        Route::get('/expense', 'ExpensesController@index')->name('expense.index');
        Route::post('/expense/store', 'ExpensesController@store')->name('expense.store');
        Route::get('/expense/destroy/{id}', 'ExpensesController@destroy')->name('expense.destroy');
    ...
    //stock taking
    Route::get('/products/stocktaking', 'ProductController@stocktaking')->name('stock.admin');
    Route::get('/invenory/create', 'ProductController@inventory')->name('inventory.create');
    Route::post('/invenory/store', 'ProductController@storeinventory')->name('inventory.store');
    Route::get('/purchase/destroy/{id}', 'ProductController@inventorydestroy')->name('inventory.destroy');
    ...
    Route::get('/all_orders', 'OrderController@all_orders')->name('all_orders.index');
     ...
     Route::get('/orders/routes', 'OrderController@all_orders_routes')->name('all_orders.routes');
     
      Route::get('/orders/sellers', 'OrderController@all_orders_sellers')->name('all_orders.sellers');
      
        Route::get('/orders/debt/report', 'OrderController@customerdebtreport')->name('all_orders.debtreport');
    ...
    //product sales
     ...
     Route::get('/orders/productsales', 'OrderController@product_sales')->name('all_orders.product_sales');
    
     Route::get('/salesby/brand', 'OrderController@brand2_sales')->name('all_orders.brandy_sales');
    


    
     Route::get('/credit/sales', 'OrderController@credit_collections')->name('all_orders.credit_collections');
    
    
    
    
      Route::get('/total/collections', 'OrderController@total_collections')->name('all_orders.total_collections');
