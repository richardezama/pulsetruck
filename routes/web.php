<?php
Route::get('app/seller/checkout2/{user_id}/{name}/{phone}/{address}/{email}/{latitude}/{longitude}/{payment_type}/{amountpaid}/{route_id}/{products}/{date}', 'Api2Controller@checkout2')->name('seller.checkoutnow2');



Route::get('deactivateroute', 'Api2Controller@deactivateroute')->name('deactivateroute');


Route::get('app/seller/changepwd/{user_id}/{password}', 'Api2Controller@changepassword')->name('seller.changepassword');


Route::post('app/seller/posting', 'Api2Controller@posting2');

Route::get('app/report/customers', 'ExportController@exportcustomers')->name('export.customers');


Route::get('app/seller/checkoutmodified/{user_id}/{name}/{phone}/{address}/{email}/{latitude}/{longitude}/{payment_type}/{amountpaid}/{route_id}/{date}', 'Api2Controller@checkoutmodified')->name('seller.checkoutnowmodify');


Route::get('app/customers', 'CustomersExport@collection');

//get customers
Route::get('app/seller/customers/{route}/{search}', 'Api2Controller@getcustomers');
...
Route::get('app/seller/deleteCartItem/{id}', 'Api2Controller@deleteCartItem')->name('seller.deleteCartItem');
Route::get('app/seller/checkout/{user_id}/{name}/{phone}/{address}/{email}/{latitude}/{longitude}/{payment_type}/{amountpaid}/{route_id}', 'Api2Controller@checkout')->name('seller.checkoutnow');
Route::get('app/seller/getOrders/{user_id}/{status}/{search}/{route_id}', 'Api2Controller@getOrders')->name('seller.getOrders');
///"+user_id+"/"+lat+"/"+lng+"/"+amountpaid+"/"+payment_type+"/"+status+"/"+order_id
Route::get('app/seller/updateOrder/{user_id}/{lat}/{lng}/{amountpaid}/{payment_type}/{status}/{order_id}', 'Api2Controller@updateOrder')->name('seller.updateOrder');

//this will be the call center ones
Route::get('app/seller/callcenter/{search}','Api2Controller@searchcustomer')->name('seller.callcenter');
