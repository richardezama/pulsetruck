       ...
       <script src="{{static_asset('assets/js/scripts.bundle.js')}}"></script>
        <script src="{{static_asset('assets/plugins/global/plugins.bundle.js')}}"></script>
		<script src="{{static_asset('assets/js/custom/landing.js')}}"></script>
        <script src="{{static_asset('assets/js/custom/pages/company/pricing.js')}}"></script>
        <script src="{{static_asset('assets/plugins/custom/fslightbox/fslightbox.bundle.js')}}"></script>
        <script src="{{static_asset('assets/plugins/custom/typedjs/typedjs.bundle.js')}}"></script>
