    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            <div class="px-20px mb-3">
                <input class="form-control bg-soft-secondary border-0 form-control-sm text-white"
                 type="text" name="" placeholder="Search in menu"
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (addon_is_activated('pos_system'))
                    @if(Auth::user()->user_type == 'admin00000')
                        <li class="aiz-side-nav-item">
                ...
                @endif
                 ...
                 <!-- Rewards -->
                @if(Auth::user()->user_type == 'admin0000000')
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-shopping-cart aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Reward System')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('reward.products')}}" class="aiz-side-nav-link {{ areActiveRoutes(['reward.products'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Reward Products')}}</span>
                                </a>
                            </li>

                             <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.points') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Reward Customers') }}</span>
                                </a>
                            </li>
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{route('rewardreport')}}" class="aiz-side-nav-link {{ areActiveRoutes(['rewardreport'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Reward Report')}}</span>
                                </a>
                            </li>
                ...
                <!-- inventory -->
                @if(Auth::user()->user_type == 'adminoooooo')
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-shopping-cart aiz-side-nav-icon"></i>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('stock.admin')}}"
                                 class="aiz-side-nav-link {{ areActiveRoutes(['stock.admin'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Stock Taking')}}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{route('stock.admin')}}"
                                 class="aiz-side-nav-link {{ areActiveRoutes(['stock.index'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Stock List')}}</span>
                                </a>
                            </li>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('dimension.index')}}"
                                     class="aiz-side-nav-link {{ areActiveRoutes(['dimension.index'])}}" >
                                        <span class="aiz-side-nav-text">{{translate('Acounting Dimensions')}}</span>
                                    </a>
                                </li>
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('expense.index')}}"
                                     class="aiz-side-nav-link {{ areActiveRoutes(['expense.index'])}}" >
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('expenses.summary')}}"
                                     class="aiz-side-nav-link {{ areActiveRoutes(['expenses.summary'])}}" >
                                        <span class="aiz-side-nav-text">{{translate('Expenses Summary')}}</span>
                                    </a>
                                </li>

                                <li class="aiz-side-nav-item">
                                    <a href="{{route('expensetypes.index')}}"
                                     class="aiz-side-nav-link {{ areActiveRoutes(['expensetypes.index'])}}" >
                                        <span class="aiz-side-nav-text">{{translate('Expense Types')}}</span>
                                    </a>
                                </li>
            ...
            <!-- Product -->
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-shopping-cart aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Vehicle Management')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('brands.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['brands.index', 'brands.create', 'brands.edit'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Models')}}</span>
                                </a>
                            </li>
                            <!--
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('units.index')}}" class="aiz-side-nav-link
                                {{ areActiveRoutes(['units.index', 'units.create', 'units.edit'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Units of Measure')}}</span>
                                </a>
                            </li>
                        -->
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('types.index')}}" class="aiz-side-nav-link
                            {{ areActiveRoutes(['types.index', 'types.create', 'types.edit'])}}" >
                                <span class="aiz-side-nav-text">{{translate('Types')}}</span>
                            </a>
                        </li>
                        </ul>
                    </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.routes') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.index', 'all_orders.routes'])}}">
                                    <span class="aiz-side-nav-text">{{translate('All Orders by Branches')}}</span>
                                </a>
                            </li>

                             <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.sellers') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.index', 'all_orders.sellers'])}}">
                                    <span class="aiz-side-nav-text">{{translate('All Orders by Sellers')}}</span>
                                </a>
                            </li>

                             <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.debtreport') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.index', 'all_orders.debtreport'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Customer Debt Report')}}</span>
                                </a>
                            </li>


                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.product_sales') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.product_sales', 'all_orders.product_sales'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Product Sales')}}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.brandy_sales') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.product_sales', 'all_orders.product_sales'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Brand Sales')}}</span>
                                </a>
                            </li>

                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.credit_collections') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.credit_collections', 'all_orders.credit_collections'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Credit Collections')}}</span>
                                </a>
                            </li>


                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.total_collections') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.total_collections', 'all_orders.total_collections'])}}">
                        ...
                        @endif
                         ...
                         @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('routes.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(
                                ['routes.index'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Branches/Bars')}}</span>
                                </a>
                            </li>
                        @endif
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Shippers') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        -->
                          ...
                          <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_orders.routes') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_orders.index', 'all_orders.routes'])}}">
                                    <span class="aiz-side-nav-text">{{translate('All Orders by Routes')}}</span>
                                </a>
                            </li>
            ...
            <!-- marketing -->
                @if(Auth::user()->user_type == 'admin000')
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-bullhorn aiz-side-nav-icon"></i>
