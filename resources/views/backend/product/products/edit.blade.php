                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('URA Category ID')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="ura_category_id"
                                value="{{ $product->ura_category_id }}"
                                placeholder="{{ translate('URA Category') }}"required>
                            </div>
                        </div>
