                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                              ...
                              <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('URA Category ID')}}
                                 <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="ura_category_id"
                                 placeholder="{{ translate('URA Category ID') }}"required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="unit_id">
                            <label class="col-md-3 col-from-label">{{translate('Ura Units')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
