                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Reward Mechanism')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="reward_mechanism"
                                value="{{ $product->reward_mechanism }}"
                                placeholder="{{ translate('Reward Mechanism') }}"required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="category">
                            <label class="col-md-3 col-from-label">{{translate('Units')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="unit_id" id="unit_id"
