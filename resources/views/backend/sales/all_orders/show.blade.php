            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>
                            <strong class="text-muted">{{translate('Amount Paid')}} :</strong>
                        </td>
                        <td>
                     ...
                     <tr>
                        <td>
                            <strong class="text-muted">{{translate('Balance')}} :</strong>
                        </td>
                        <td>
...
@section('script')
    <script type="text/javascript">
        ...
        $('#update_payment_status').on('change', function(){
            ...
            $.post('{{ route('orders.update_payment_status') }}', {_token:'{{ @csrf_token() }}',
            order_id:order_id,status:status}, function(data){
               // alert(JSON.stringify(data));
               if(data==2){
 AIZ.plugins.notify('warning', '{{ translate('order already fully paid') }}');
               }
               else{
 AIZ.plugins.notify('success', '{{ translate('Payment status has been updated') }}');
        ...
        $('#update_tracking_code').on('change', function(){
            ...
            {_token:'{{ @csrf_token() }}',order_id:order_id,tracking_code:tracking_code}, function(data){
