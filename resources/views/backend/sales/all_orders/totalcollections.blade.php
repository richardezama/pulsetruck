...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
            ...
            <div class="col-lg-2">
              ...
              <div class="col-lg-2 ml-auto">
                <select class="form-control aiz-selectpicker" name="detailed">
                    <option value="1" @if ($detailed == '1') selected @endif>{{translate('Total')}}</option>
                    <option value="2" @if ($detailed == '2') selected @endif>{{translate('Detailed')}}</option>
                ...
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md">{{ translate('Customer') }}</th>
                         ...
                         <th data-breakpoints="md">{{ translate('Phone') }}
                        </th>
                          <th data-breakpoints="md">{{ translate('Payment') }}
                        </th>
                          <th data-breakpoints="md">{{ translate('Credit Balance') }}
                        </th>
                          <th data-breakpoints="md">{{ translate('Route') }}
                        </th>
                           <th data-breakpoints="md">{{ translate('Order Date') }}
                        </th>
                          <th data-breakpoints="md">{{ translate('Payment Date') }}
                        </th>
                    ...
                    <tr>
                       <td>
                        ...
                        <td>
                          ...
                          <td>
                            {{ number_format($order->total) }} Shs
                        </td>
                       
                         <td>
                          
                           {{ number_format($order->balance) }} Shs
                        </td>
