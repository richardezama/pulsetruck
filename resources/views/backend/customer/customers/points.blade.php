            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg">{{translate('Total Points')}}</th>
                       
                        <th>{{translate('Action (Reward)')}}</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        @if ($user != null)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{route('customer.reward',$user->id)}}" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="{{ translate('Reward Customer') }}">
