...
class AdminController extends Controller
{
    ...
    {  
        ...
        $unorders=Order::where("payment_status","unpaid")->get();
        $credit=0;
        foreach($unorders as $order)
        {
            $credit+=$order->grand_total-$order->amount_paid;
        }
        return view('backend.dashboard', compact('root_categories', 'cached_graph_data','credit'));
    }
